...
\begin{frame}{Идея}
	...
	\begin{figure}[h]
    \center{\includegraphics[width=0.48\linewidth]{1.eps} \\График зависимости точности классификации от процента удалённых параметров}
    \label{ris:image1}
    \end{figure}
...
\hfill
\begin{minipage}[h]{0.49\linewidth}
\center{\includegraphics[width=1\linewidth]{2.png} \\ Гиперсеть с отображением во множество матриц низкого ранга}
\end{minipage}
...
\hfill
\begin{minipage}[h]{0.49\linewidth}
\center{\includegraphics[width=1\linewidth]{3.png} \\ Гиперсеть с линейной аппроксимацией}
\end{minipage}
...
\hfill
\begin{minipage}[h]{0.49\linewidth}
\center{\includegraphics[width=1\linewidth]{4.png} \\ Модель с низкоранговой аппроксимацией с дообучением}
\end{minipage}
...
\hfill
\begin{minipage}[h]{0.49\linewidth}
\center{\includegraphics[width=1\linewidth]{5.png} \\ Модель с линейной аппроксимацией с дообучением}
\end{minipage}
